...
void LookAt ( Vectorf::Vector3f* eye, Vectorf::Vector3f* center, Vectorf::Vector3f* up )
{
	gluLookAt ( eye->getX ( ), eye->getY ( ), eye->getZ ( ), center->getX ( ), center->getY ( ), center->getZ ( ), up->getX ( ), up->getY ( ), up->getZ ( ) );
}

double toRadians ( double radValue )
{
